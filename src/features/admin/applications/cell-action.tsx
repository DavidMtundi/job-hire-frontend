  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <button
        ...
        className="px-4 py-2 text-white font-medium rounded-md bg-gradient-to-r from-primary via-primary/90 to-primary/80 hover:from-primary/90 hover:via-primary/80 hover:to-primary/70 transition-all duration-200 shadow-sm hover:shadow-md"
      >
        View Application
      </button>
    </div>
