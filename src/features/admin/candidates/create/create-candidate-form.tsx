      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Please provide candidate personal information</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Please provide candidate professional information</CardDescription>
          </CardHeader>
          <CardContent>
