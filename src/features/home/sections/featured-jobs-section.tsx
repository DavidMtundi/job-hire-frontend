...
export const FeaturedJobsSection = () => {
  ...
  //   },
  //   {
  //     id: "c07d9e2e-8b44-4f9f-a211-1b32f8d44e24",
  //     title: "Product Designer",
  //     company: "Must Company",
  //     department: "Design",
  //     description: "The Sr Product Designer will be responsible for creating production assets for our products.",
  ...
  //   },
  //   {
  //     id: "c07d9e2e-8b43-4f9f-a211-1b32f8d44d23",
  //     title: "Frontend Engineer",
  //     company: "Must Company",
  //     department: "Engineering",
  //     description: "We are looking for a passionate Frontend Engineer to join our dynamic team. You’ll work on building high-performance, visually stunning, and user-friendly web applications. Our ideal candidate has a keen eye for detail, strong problem-solving skills, and a drive for creating seamless digital experiences.",
  ...
  //   },
  //   {
  //     id: "c07d9e2e-8b43-4f9f-a211-1b32f8d64e73",
  //     title: "Backend Engineer",
  //     department: "Engineering",
  //     company: "Must Company",
  //     description: "We are looking for a passionate Frontend Engineer to join our dynamic team. You’ll work on building high-performance, visually stunning, and user-friendly web applications. Our ideal candidate has a keen eye for detail, strong problem-solving skills, and a drive for creating seamless digital experiences.",
  ...
  const { data: jobsData, isLoading, error, refetch } = useGetJobsQuery({ is_featured: true });
    ...
    <section className="w-full px-4 py-16">
      <div className="container mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold text-gray-800">Featured Job Circulars</h2>
...
const FeaturedJobCard = ({ job }: { job: TJob }) => {
  return (
    <div
      key={job.id}
      className="flex flex-col border rounded-2xl p-6 justify-between transition-transform hover:shadow-lg"
    >
      <div>
        <div className="mb-4">
